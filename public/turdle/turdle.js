...
this.wordle.bundle = function(e) {
    ...
    function u(e, a, s) {
        return (u = reflectionAvailable() ? Reflect.construct : function(e, a, s) {
            var t = [null];
            t.push.apply(t, a);
    ...
    var La = window.playwords || window.allwords
      , Ta = window.allwords
      , Ia = "present"
      , Ma = "correct"
      , Oa = "absent";
    ...
    var Za = "IN_PROGRESS"
      , es = "WIN"
      , as = "FAIL"
      , ss = ["Lucky Guesser", "Genius", "Magnificent", "Impressive", "Splendid", "Great", "Nothing To Brag About", "Phew"]
      , ts = function(e) {
        r(t, e);
        var a = h(t);
        function t() {
            ...
            !e.lastPlayedTs || Na(new Date(e.lastPlayedTs), e.today) >= 1 ? (e.boardState = new Array(8).fill(""),
            e.evaluations = new Array(8).fill(null),
        ...
        return o(t, [{
            key: "evaluateRow",
            value: function() {
                if (6 === this.tileIndex && !(this.rowIndex >= 8)) {
            ...
            key: "addLetter",
            value: function(e) {
                this.gameStatus === Za && (this.canInput && (this.tileIndex >= 7 || (this.boardState[this.rowIndex] += e,
            ...
            value: function() {
                ...
                for (var a = 0; a < 8; a++) {
                    ...
                    s.setAttribute("length", 6),  // TODO: Adjust word length here
...
var interval = setInterval( () => {
  console.log('Waiting for word list...');
  if (window.allwords) {
